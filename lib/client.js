...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CONFIG_DEFAULTS = {
      ...
      subagentApprovalSound: 'none',
      subagentQuestionSound: 'none',
      subagentPlanReviewSound: 'none',
      subagentGoalBlockedSound: 'none',
      subagentFailureSound: 'none',
    ...
    function makeSection(store) {
      function Section() {
        ...
        var buildSubagentRows = function () {
          return SUBAGENT_EVENTS.map(function (e) {
            return React.createElement(EventRow, {
              key: 'subagent-' + e.kind,
              kind: e.kind,
              source: 'subagent',
        ...
        return React.createElement('div', { className: 'dns-notify-page' },
          ...
          tab === 'main'
            ...
            : React.createElement('div', null,
                React.createElement('div', { className: 'dns-notify-row' },
                  React.createElement('span', { className: 'dns-notify-title' }, '忽略子代理事件'),
                  React.createElement(EnableSwitch, {
